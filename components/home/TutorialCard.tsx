...
const TutorialCard = () => {
    return (
        ...
        <a target="_blank" href="https://www.shaderobotics.com/posts/making-the-most-out-of-the-shade-registry">
            <div className="shadow-md 
                ...
                <div className='space-y-2 mt-4 flex flex-col h-full'>
                    ...
                    <h1 className='text-xl sm:text-2xl font-bold flex-1 w-3/5'>Making the most out of the Shade Registry</h1>
